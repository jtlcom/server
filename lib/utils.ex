defmodule Utils do
  ...
  def diff_days(t1, t2, by_zero \\ false) do
    datetime1 =
      (by_zero && Timex.beginning_of_day(timestamp_to_datetime(t1))) || timestamp_to_datetime(t1)

    datetime2 =
      (by_zero && Timex.beginning_of_day(timestamp_to_datetime(t2))) || timestamp_to_datetime(t2)

    (t1 >= t2 && Timex.diff(datetime1, datetime2, :days)) ||
      Timex.diff(datetime2, datetime1, :days)
  end
end

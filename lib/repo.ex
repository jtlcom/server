defmodule Repo do
  ...
  Logger.debug "Repo -> migrate(:character, vsn, character) do vsn is #{inspect vsn}, character_vsn is #{inspect Map.get(character, :vsn, 0)}"
  character =
    case Map.get(character, :vsn, 0) do         #如果character中的 vsn 为传进来的vsn，则不对character数据做修改
      ...
      1 -> character |> Map.put(:periods, %{}) |> Map.put(:vsn, 2)

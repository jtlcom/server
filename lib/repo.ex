    ...
    case Map.get(character, :vsn, 0) do         #如果character中的 vsn 为传进来的vsn，则不对character数据做修改
      ...
      # Logger.debug "case 0"
        ...
        |> Map.merge(%{level: 1,
                       ...
                       pos: %{map: 1, x: 10, y: 10},
                       bag: %{0 => %{id: 3, count: 1000}, 1 => %{id: 1, count: 1000}, 2 => %{id: 2, count: 1000}, 3 => %{id: 4, count: 1000},  4 => %{id: 5, count: 1000}, 5 => %{id: 6, count: 1000},
                       6 => %{count: 1000, id: 1001}, 7 => %{count: 1000, id: 1002}, 8 => %{count: 1000, id: 201}, 9 => %{count: 1000, id: 202}, 10 => %{count: 1000, id: 203}, 11 => %{count: 1000, id: 301},
                       12 => %{count: 1000, id: 401}, 13 => %{count: 1000, id: 501}, 14 => %{count: 1000, id: 802}, 15 => %{count: 1000, id: 810}},
                       bagCells: @init_cells,
